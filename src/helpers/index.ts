...
export const isScrollBottom = (
  ...
  gapFromBottom: number = 0
): boolean => {
  let position = element.scrollTop;
  let scrollerBarHeight =
...
*/
export const eventFinishedWaiter = (eventName: string, ms?: number, action?: Function) => {
